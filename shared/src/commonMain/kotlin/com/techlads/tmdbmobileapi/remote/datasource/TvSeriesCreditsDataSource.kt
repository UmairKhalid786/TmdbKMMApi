...
import com.techlads.tmdbmobileapi.remote.responses.CreditsResponse

class TvSeriesCreditsDataSource(private val network: NetworkClient) {
    suspend fun get(
        tvSeriesId: Int = 1,
        ...
        val url = BASE_URL + "tv/$tvSeriesId/credits"
